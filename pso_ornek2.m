...
% PSO - (x - 2)^2 fonksiyonunu minimize etme

% Amaç fonksiyonu
CostFunction = @(x) (x - 2).^2;

nVar = 1;              % Tek boyutlu problem
VarSize = [1 nVar];    % Pozisyon vektörü
VarMin = -10;          % Alt sınır
VarMax = 10;           % Üst sınır

% PSO Parametreleri
MaxIt = 50;            % Maksimum iterasyon
nPop = 10;             % Parçacık sayısı
...
grid on;
title('PSO Sonucu - (x - 2)^2 Fonksiyonu');
